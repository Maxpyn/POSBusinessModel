"""
Django settings for ceemart project.
...
FINANCIAL_KPI_PIN = os.environ.get('FINANCIAL_KPI_PIN', '')
...
if not SECRET_KEY:
    ...
    SECRET_KEY = 'local-development-key-change-this'
...
WSGI_APPLICATION = 'ceemart.wsgi.application'
